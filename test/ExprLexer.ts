...
export class ExprLexer extends Lexer {
	...
	public static readonly _serializedATN: string =
		...
		"\x02C\\c|\x06\x022;C\\aac|\x05\x02\v\f\x0F\x0F\"\":\x02\x03\x03\x02\x02"+
		...
		"\x15/\x03\x02\x02\x02\x176\x03\x02\x02\x02\x19\x1A\t\x02\x02\x02\x1A\x1B"+
		"\t\x03\x02\x02\x1B\x1C\t\x04\x02\x02\x1C\x04\x03\x02\x02\x02\x1D\x1E\t"+
